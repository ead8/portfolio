...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      Greetings, I&apos;m a <span className="text-AAsecondary">MERN/MEVN developer</span>, proficient in crafting digital solutions with a passion for code.
      <br className="2xl:block hidden" />
      My expertise lies in <span className="text-AAsecondary">React.js</span>,<span className="text-AAsecondary">Vue3</span> and <span className="text-AAsecondary">Node.js</span>,
      building scalable applications with an eye for detail.
      <br className="2xl:block hidden" />
      Adept at problem-solving, whether it&apos;s architecting <span className="text-AAsecondary">APIs</span> or designing seamless UIs.
      <br className="2xl:block hidden" />
      Dedicated to enhancing user experiences through innovative technology, I embrace challenges and am committed to lifelong learning.
    </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
